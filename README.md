...
[![Go Reference](https://pkg.go.dev/badge/github.com/fmotalleb/mithra.svg)](https://pkg.go.dev/github.com/fmotalleb/mithra)
[![go.mod](https://img.shields.io/github/go-mod/go-version/fmotalleb/mithra)](go.mod)
[![LICENSE](https://img.shields.io/github/license/fmotalleb/mithra)](LICENSE)
[![Go Report Card](https://goreportcard.com/badge/github.com/fmotalleb/mithra)](https://goreportcard.com/report/github.com/fmotalleb/mithra)
[![Codecov](https://codecov.io/gh/fmotalleb/mithra/branch/main/graph/badge.svg)](https://codecov.io/gh/fmotalleb/mithra)
...
3. Replace all occurrences of `fmotalleb/mithra` to `your_org/repo_name` in all files.
